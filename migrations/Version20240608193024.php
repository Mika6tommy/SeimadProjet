 ...
 */
final class Version20240608193024 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE property_image CHANGE actualite_id actualite_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE property_image CHANGE actualite_id actualite_id INT NOT NULL');
    }
}
